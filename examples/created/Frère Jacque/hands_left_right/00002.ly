...
\new GrandStaff <<
\new Staff { \key c \major \clef treble \time 4/4 \clef treble \time 4/4 \key c \major c'4 d'4  
#(define color-mapping-0
(list
(cons (ly:make-pitch 0 2 ) (x11-color 'OrangeRed))
))
...
\once \override NoteHead #'color = #color-notehead-0 
 e'4 c'4 }
\new Staff { \key c \major \clef bass \time 4/4 \clef bass r1 }
>>
